...
- Enter Reflections: Replace the `underscore followed by enter` in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
**Trying to split the function as much as possible so that code is understableand readable.will try to Avoid high cyclomatric complexity for a function**
